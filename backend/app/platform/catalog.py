...
MODULE_CATALOG: list[ModuleDef] = [
    ...
    ModuleDef("pipeline",   "Pipeline",   8,  "/pipeline",   "SquareKanban",    "deals:read"),
    ModuleDef("calendar",   "Calendar",   9,  "/calendar",   "Calendar",        "calendar:read"),
    ModuleDef("tasks",      "Tasks",      10,  "/tasks",      "ListTodo",        "tasks:read"),
    ModuleDef("projects",   "Projects",   11,  "/projects",   "FolderKanban",    "projects:read"),
    ModuleDef("products",   "Products",   12, "/products",   "Package",         "products:read"),
    ModuleDef("quotations", "Quotations", 13, "/quotations", "FileText",        "quotations:read"),
    ModuleDef("invoices",   "Invoices",   14, "/invoices",   "Receipt",         "invoices:read"),
    ModuleDef("support",    "Support",    15, "/support",    "LifeBuoy",        "support:read"),
    ModuleDef("reports",    "Reports",    16, "/reports",    "ChartColumnBig",  "reports:read"),
    ModuleDef("settings",   "Settings",   17, "/settings",   "Settings",        "settings:read", locked=True),
]
