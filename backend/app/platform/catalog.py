...
MODULE_CATALOG: list[ModuleDef] = [
    ...
    ModuleDef("pipeline",   "Pipeline",   6,  "/pipeline",   "SquareKanban",    "deals:read"),
    ModuleDef("calendar",   "Calendar",   7,  "/calendar",   "Calendar",        "calendar:read"),
    ModuleDef("tasks",      "Tasks",      8,  "/tasks",      "ListTodo",        "tasks:read"),
    ModuleDef("projects",   "Projects",   9,  "/projects",   "FolderKanban",    "projects:read"),
    ModuleDef("products",   "Products",   10, "/products",   "Package",         "products:read"),
    ModuleDef("quotations", "Quotations", 11, "/quotations", "FileText",        "quotations:read"),
    ModuleDef("invoices",   "Invoices",   12, "/invoices",   "Receipt",         "invoices:read"),
    ModuleDef("support",    "Support",    13, "/support",    "LifeBuoy",        "support:read"),
    ModuleDef("reports",    "Reports",    14, "/reports",    "ChartColumnBig",  "reports:read"),
    ModuleDef("settings",   "Settings",   15, "/settings",   "Settings",        "settings:read", locked=True),
]
