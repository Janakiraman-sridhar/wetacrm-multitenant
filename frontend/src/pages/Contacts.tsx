...
export default function Contacts() {
  ...
  const fields: FieldDef[] = [
    ...
    { name: "mobile", label: "Mobile", placeholder: "98765 43210" },
    ...
    // --- the other ways to reach them, and who they work for ----------------
    { name: "position", label: "Position / title", section: "Work & other contacts" },
    {
      name: "company_id",
      label: "Company",
      type: "select",
